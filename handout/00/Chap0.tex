...
\vspace{1em}
\begin{center}
\Large{Welcome to enroll Communism Theory !}
\end{center}
\end{frame}
\begin{frame}{Course Information}
\begin{itemize}
\item Instructor: Tzu-Chi Hsiao.
\item Course: Communism Theory.
\item Credit: 3.
...
\begin{itemize}
\item We interest in why communism party can achieve its goals in twenty century.
\item We will briefly talk about
\begin{itemize}
\item The fundamental of communism.
\item Example I: The Soviet Union.
\item Example II: The Chinese Communist Party.
\end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
\item Lecture notes by Tzu-Chi Hsiao.
\end{itemize}
\end{frame}
